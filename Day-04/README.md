...
You type a number, the computer picks its move, and Python decides who wins.
Simple game, but it introduces some of the most useful tools in Python.
...
You have to `import` it first, it's not available by default.
...
Not just answering questions or following a path, but the actual logic,
actual randomness, actual game mechanics.
